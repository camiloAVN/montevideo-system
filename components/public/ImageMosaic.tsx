    ...
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 auto-rows-[150px] md:auto-rows-[200px]">
          {images.map((image, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-pink-600/20 via-transparent to-amber-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              ...
              <div className="absolute inset-[1px] rounded-2xl overflow-hidden bg-gray-900">
                ...
                {errorImages.has(index) ? (
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 flex flex-col items-center justify-center">
                    <div className="relative">
                      <div className="absolute inset-0 bg-pink-600/20 blur-xl rounded-full" />
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-4 md:p-6 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                  <span className="text-xs md:text-sm text-pink-400 font-medium mb-1">
                ...
                {/* Corner Accent */}
                <div className="absolute top-3 right-3 w-2 h-2 md:w-3 md:h-3 rounded-full bg-pink-600 opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:scale-100 scale-0" />
              </div>

              {/* Glow Effect */}
              <div className="absolute -inset-1 bg-gradient-to-r from-pink-700 to-amber-600 rounded-2xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 -z-10" />
            </div>
          ))}
        </div>
        ...
        <div className="mt-12 flex justify-center">
          <div className="h-1 w-32 bg-gradient-to-r from-transparent via-pink-600 to-transparent rounded-full" />
        </div>
      </div>
    </section>
  )
