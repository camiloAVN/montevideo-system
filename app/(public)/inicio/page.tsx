        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="glass p-8 rounded-xl hover:border-pink-600/40 transition-all duration-200 group"
              >
                <h3 className="text-xl font-bold text-gray-200 mb-3 group-hover:text-pink-400 transition-colors">
                  {service.title}
                </h3>
                ...
                <ul className="space-y-2">
                  {service.features.map((feature, i) => (
                    <li key={i} className="text-sm text-gray-500 flex items-center">
                      <span className="w-1.5 h-1.5 bg-pink-600 rounded-full mr-2" />
                      {feature}
                    </li>
                  ))}
                </ul>
