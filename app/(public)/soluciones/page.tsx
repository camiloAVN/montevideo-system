          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="relative">
                {index < 3 && (
                  <div className="hidden md:block absolute top-12 left-1/2 w-full h-0.5 bg-gradient-to-r from-pink-600 to-transparent" />
                )}
                <div className="glass p-6 rounded-xl text-center relative z-10">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-pink-600 to-amber-500 flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                    {phase.step}
                  </div>
