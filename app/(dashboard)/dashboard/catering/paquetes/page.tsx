  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-100">Paquetes</h1>
          <p className="text-gray-400 text-sm mt-0.5">Paquetes completos de catering para eventos</p>
        </div>
        <button
          disabled
      ...
      <div className="glass rounded-2xl p-12 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-lg font-semibold text-gray-200 mb-2">Paquetes de Catering</h2>
        <p className="text-gray-500 text-sm max-w-sm">
          Aquí podrás gestionar los paquetes de catering completos para eventos: empresarial, social, gourmet, económico y más.
