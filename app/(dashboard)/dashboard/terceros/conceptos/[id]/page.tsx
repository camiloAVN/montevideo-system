  ...
  if (!currentConcept) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/dashboard/terceros/conceptos" className="text-pink-400 hover:underline mt-2 inline-block">
          Volver a conceptos
        </Link>
      </div>
    )
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-3 text-sm text-gray-500">
              ...
              {currentConcept.category && (
                <span className="px-2 py-0.5 rounded-full bg-amber-500/10 text-pink-400 font-medium">
