                      ...
                      <div className="bg-gray-800/50 px-4 py-3 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                          <button
                            ...
                            className="text-xs text-pink-400 hover:text-orange-300"
                          >
                            Ver todos
                          </button>
                          <button
                            ...
                            <div className="flex items-center gap-6">
                              <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                  ...
                                  className="w-4 h-4 rounded border-gray-600 bg-gray-800 text-pink-600 focus:ring-pink-600 focus:ring-offset-gray-900"
                                />
