    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-3">
            <ListTodo className="w-8 h-8 text-pink-400" />
            Tareas
          </h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold mt-1 text-pink-400">{inProgressTasks}</p>
        </div>
        <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
                        ...
                        <div className="flex items-start justify-between gap-4">
                          ...
                          {hasEditPermission && (
                            <select
                              ...
                              className="text-xs bg-gray-900 border border-gray-700 rounded-md px-2 py-1 text-gray-300 focus:outline-none focus:ring-1 focus:ring-pink-600"
                            >
                              {Object.entries(taskStatusLabels).map(([value, label]) => (
                        ...
                        <div className="flex flex-wrap items-center gap-2 mt-3">
                          ...
                          {task.project && (
                            <Link
                              ...
                              className="flex items-center gap-1 text-xs text-pink-400 hover:text-orange-300 transition-colors"
                            >
