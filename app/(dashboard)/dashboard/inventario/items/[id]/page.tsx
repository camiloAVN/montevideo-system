...
const typeConfig = {
  UNIT: { label: 'Unidad', className: 'bg-pink-600/10 text-pink-400' },
...
const movementTypeConfig: Record<string, { label: string; className: string }> = {
  ...
  ENROLLMENT: { label: 'Registro', className: 'text-pink-400' },
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Link
                    ...
                    className="mt-1 flex items-center gap-2 text-pink-400 hover:text-orange-300"
                  >
                    {item.product?.name}
                    {item.product?.brand && (
              ...
              <Card.Header>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-2 px-2 py-0.5 rounded-full text-xs font-medium bg-pink-600/10 text-pink-400">
                          ...
                          <tr key={content.id}>
                            <td>
                              <Link
                                ...
                                className="font-mono text-sm text-pink-400 hover:text-orange-300"
                              >
