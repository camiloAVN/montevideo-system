  ...
  if (!currentGroup) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/dashboard/inventario/grupos" className="text-pink-400 hover:underline mt-2 inline-block">
          Volver a grupos
        </Link>
      </div>
    )
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div className="flex items-start gap-4">
          <div className="p-3 rounded-xl bg-pink-600/10">
            <Package2 className="w-8 h-8 text-pink-400" />
          </div>
          <div>
            ...
            <div className="flex items-center gap-4 mt-2 text-sm text-gray-500">
              ...
              <span className="px-2 py-0.5 rounded-full bg-pink-600/10 text-pink-400 font-medium">
