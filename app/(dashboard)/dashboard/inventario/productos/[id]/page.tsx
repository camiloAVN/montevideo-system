...
export default function ProductDetailPage() {
  ...
  const getStatusBadge = (status: string) => {
    const styles = {
      ...
      MAINTENANCE: 'bg-pink-600/10 text-pink-400',
  ...
  const getConditionBadge = (condition: string) => {
    const styles = {
      ...
      POOR: 'bg-pink-600/10 text-pink-400',
            ...
            <Card.Content>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="mt-1 font-semibold text-lg text-pink-400">
                  ...
                  {product.suppliers.map((ps) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        {ps.isPreferred && (
                          <span className="text-xs text-pink-400">Preferido</span>
                        )}
                      </div>
                    </div>
                  ))}
