  ...
  return (
    <Card variant="glass" className="p-8">
      ...
      <div className="text-center mb-8">
        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-600 to-amber-500 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-pink-600/50">
